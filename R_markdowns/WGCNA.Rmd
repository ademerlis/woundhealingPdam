...
adjacency = adjacency(datExpr_lrt, 
                     ...
                     maxPOutliers = 0.05, #recommended when bicor is used, this is recommended if there is a binary variable used (i.e. disease status or genotype). this argument forces bicor to never regard more than the specified proportion of samples as outliers
                       power = softPower,
...
#For condition, the modules most positively correlated (red) are MEdarkgreen, MEbrown, and MEbrown4. The modules most negatively correlated (green) are MEsaddlebrown and MEdarkorange
```
